...
public class MyOffers {
    ...
    public static void main(String[] args) {
        ...
        offer1.setInfo("Toulon","CYDEO","SDET",45000,true, true, true, false);

        Offer offer2 = new Offer();
        offer2.setInfo("CA","Amazon","DEV",70000,true, false, false, true);

        Offer offer3 = new Offer();
        offer3.setInfo("Paris","Sony Inc","QE",80000,true, true, true, false);

        Offer offer4 = new Offer();
        offer4.setInfo("WA","Bank Of America","BA",1000000,true, true, false, true);

        Offer offer5 = new Offer();
        offer5.setInfo("Florida","Samsung","SDET",110000,false, true, false, true);
        ...
        fullTimeOffers.removeIf(p-> ! p.isFullTime); // removes if the offer's not fulltime

        System.out.println(fullTimeOffers.size());

        ArrayList<Offer> localOffers = new ArrayList<>(Arrays.asList(myOffers));

        localOffers.removeIf(p-> ! (p.location.equals("WA"))  );  // removes the offer if it s not from local area
