...
public class StringIntro {
    ...
    public static void main(String[] args) {
        ...
        String name = "Wooden Spoon";      // In the heap, only one String Literal object is stored
        String name2= "Wooden Spoon";      // Because all of these names is the same
        ...
        String s3= "Java";
        String s4= new String("java");    //  "j" written with lower case!!!!   //
