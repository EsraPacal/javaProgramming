...
public class WarmupTasks {
    ...
    public static void main(String[] args) {
        ...
        // System.out.println(Arrays.toString(arr));  =====> in order to print this array, we have to call Arrays.toString
        ...
        //specialChars.removeAll(digits);        we can find the specialChars with this way as well

        specialChars.removeIf(p ->  Character.isLetterOrDigit(p) );  // remove the chars that are not special chars
